...
//	LPBYTE aGray=new BYTE[in->height*in->width];
//	LPBYTE aBinImg=new BYTE[in->height*in->width];
...
//*/
//参考资料：贾云德 机器视觉\章毓晋 图象处理和分析\郎锐 数字图象处理学\王娜 李霞 一种新的改进Canny边缘检测算法